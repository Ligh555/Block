...
public class PickerView extends View {
    ...
    public void setSelected(String mSelectItem) {
        for (int i = 0; i < mDataList.size(); i++) {
            if (mDataList.get(i).getShowConetnt ().equals(mSelectItem)) {
                setSelected(i);
                break;
            }
        }
    ...
    public String getmCurrentString() {
        return mDataList.get(mCurrentSelected).getShowConetnt();
    }

    public void setParameter(float textScan, String textColor){
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // 按照View的高度计算字体大小
        mMaxTextSize = mViewHeight / textScan;
