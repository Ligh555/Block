...
package com.ligh.wheelview.widget.layout;
...
import com.ligh.wheelview.annotation.CurtainCorner;
import com.ligh.wheelview.annotation.ItemTextAlign;
import com.ligh.wheelview.annotation.ScrollState;
import com.ligh.wheelview.contract.OnWheelChangedListener;
...
public abstract class BaseWheelLayout extends LinearLayout implements OnWheelChangedListener {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setVisibleItemCount(typedArray.getInt(R.styleable.BaseWheelLayout_wheel_visibleItemCount, 3));
