 ...
 **/
class MainAdapter(context: Context) : ListAdapter<ItemModel, MainAdapter.MainViewHolder>(
    DiffCallback()
) {
    ...
    class StubViewHolder(view: View) : MainViewHolder(view)
